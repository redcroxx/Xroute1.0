...
<!--
	...
	document.write("<object id='UbiViewer' classid='CLSID:256887A3-916F-4C82-86B3-F432BA83097B' codebase='" + codebase + "UbiViewerXUni.cab#version=" + cab_ver + "' width='" + w + "px' height='" + h + "px'>");
