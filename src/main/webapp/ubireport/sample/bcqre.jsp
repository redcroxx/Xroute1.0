...
<!--
	...
	document.write("	<param name='DocName'				value='default'>");	// Bcqre config.xml에 설정된 DOC name.
	document.write("	<param name='PageNames'				value='default$'>");// Bcqre config.xml에 설정된 Page name.
	...
	document.write("	<param name='issueNumber'			value=''>");		// 사용안함.
