...
<body style="background-color: #f0f0f0;">
    <nav class="navbar navbar-light" style="margin-bottom: 30px; background-color: #ffa200;">
        <a class="navbar-brand" href="#">
            <img src="/images/main/privacy-policy.png" width="30" height="30" class="d-inline-block align-top" alt=""> 개인정보처리방침
        </a>
    </nav>
    <div class="container">
        <div class="wrapPopup">
            <div class="innerBox" style="background-color: #e3e3e3; padding: 15px 15px 15px 15px;">
                <div class="boxArea terms" tabindex="0">
                    <p>엑스루트(이하 ‘회사’라 한다)는 개인정보 보호법 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리지침을 수립․공개합니다.</p>
                    ...
                    <p>1. 홈페이지 회원 가입 및 관리<br>회원 가입의사 확인, 회원제 서비스 제공에 따른 본인 식별․인증, 회원자격 유지․관리, 제한적 본인확인제 시행에 따른 본인확인, 서비스 부정이용 방지, 만 14세 미만 아동의 개인정보처리시 법정대리인의 동의여부 확인, 각종 고지․통지, 고충처리 등을 목적으로 개인정보를 처리합니다.</p>
                    <p>2. 재화 또는 서비스 제공<br>물품배송, 서비스 제공, 계약서․청구서 발송, 콘텐츠 제공, 맞춤서비스 제공, 본인인증, 연령인증, 요금결제․정산, 채권추심 등을 목적으로 개인정보를 처리합니다.</p>
                    <p>3. 고충처리<br>민원인의 신원 확인, 민원사항 확인, 사실조사를 위한 연락․통지, 처리결과 통보 등의 목적으로 개인정보를 처리합니다.</p>
                    ...
                    <ul>
                        <li>
                            1. 홈페이지 회원 가입 및 관리 : 사업자/단체 홈페이지 탈퇴시까지<br>다만, 다음의 사유에 해당하는 경우에는 해당 사유 종료시까지
                            <ul>
                        ...
                        <li>
                            2. 재화 또는 서비스 제공 : 재화․서비스 공급완료 및 요금결제․정산 완료시까지<br>다만, 다음의 사유에 해당하는 경우에는 해당 기간 종료시까지
                            <ul>
                    ...
                    <ul>
                        <li>
                            1. 전화 상담센터 운영
                            <ul>
                                <li>- 위탁받는 자 (수탁자) : 해당없음</li>
                                <li>- 위탁하는 업무의 내용 : 해당없음</li>
                            </ul>
                        </li>
                        <li>
                            2. A/S 센터 운영
                    ...
                    <ul>
                        ...
                        <li>3. 인터넷 서비스 이용과정에서 아래 개인정보 항목이 자동으로 생성되어 수집될 수 있습니다.<br>예) IP주소, 쿠키, MAC주소, 서비스 이용기록, 방문기록, 불량 이용기록 등</li>
                    </ul>
                    ...
                    <ul>
                        <li>
                            1. 파기절차<br>회사는 파기 사유가 발생한 개인정보를 선정하고, 회사의 개인정보 보호책임자의 승인을 받아 개인정보를 파기합니다.
                        </li>
                        <li>
                    ...
                    <strong>8조(개인정보의 안전성 확보조치)</strong>
                    <p>회사는 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고 있습니다.</p>
                    <ul>
                        <li>1. 관리적 조치 : 내부관리계획 수립․시행, 정기적 직원 교육 등</li>
                        <li>2. 기술적 조치 : 개인정보처리시스템 등의 접근권한 관리, 접근통제시스템 설치, 고유식별정보등의 암호화, 보안프로그램 설치</li>
                    ...
                    <ul>
                        <li>
                            ...
                            <ul>
                                <li>성명 : 김광희</li>
                                <li>직책 : 부서장</li>
                                <li>연락처 : 전화번호 02-6956-6603, 이메일 : info@xroute.co.kr, 팩스번호 : 070-8233-6603</li>
                    ...
                    <ul>
                        <li>
                            ...
                            <ul>
                                <li>부서명 : 엑스루트 팀</li>
                                <li>담당자 : 김광희</li>
                                <li>연락처 : 전화번호02-6956-6603, 이메일 : info@xroute.co.kr, 팩스번호 : 070-8233-6603</li>
                            </ul>
                        </li>
                    </ul>
                    ...
                    <p>이 개인정보 처리방침은 2020. 04. 01부터 적용됩니다.</p>
                </div>
            </div>
