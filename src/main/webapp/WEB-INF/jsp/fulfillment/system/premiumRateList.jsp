...
<script type="text/javascript">
    ...
    function cfn_retrieve() {
        ...
        var url = "/fulfillment/system/premiumRate/getSearch.do";
    ...
    function cfn_save() {
        ...
        if (confirm("수정하시겠습니까?")) {
            var sid = "updateRateList";
            var url = "/fulfillment/system/premiumRate/updateRateList.do";
    ...
    function openLayerPopup() {
        var url = "/fulfillment/system/premiumRate/pop/view.do";
        var pid = "premiumRatePop";
        var params = {};
