...
-->
<!-- 검색 시작 -->
<div id="upsRatePop" class="pop_wrap">
    <!-- 그리드 시작 -->
    <div class="ct_top_wrap">
        <div class="grid_top_wrap">
            <div class="grid_top_left">UPS 요율 목록
                <span>(총 0건)</span>
            </div>
...
<script type="text/javascript">
    ...
    // 등록 컬럼.
    var _GRIDCOLUMNS = ["KG", "ZONE1", "ZONE2", "ZONE3", "ZONE4", "ZONE5", "ZONE6", "ZONE7", "ZONE8", "ZONE9", "ZONE10"];
    
    // 초기 로드.
    $(function() {
        $("#upsRatePop").lingoPopup({
            title : "UPS 요율 등록",
            width : 1000,
            height : 800,
            buttons : {
    ...
    function setSave() {
        ...
        var url = "/fulfillment/system/upsRate/pop/setSave.do";
        ...
        gfn_ajax(url, true, sendData, function(data, xhr) {
            if (data.CODE == "1") {
                cfn_msg("INFO", "UPS 요율표 등록 완료");
                $("#upsRatePop").lingoPopup("close", "OK");
            }
        });
    }
