...
-->
<!-- 검색 시작 -->
<div id="dhlRatePop" class="pop_wrap">
    <!-- 그리드 시작 -->
...
<script type="text/javascript">
    ...
    // 등록 컬럼.
    var _GRIDCOLUMNS = ["KG", "ZONE1", "ZONE2", "ZONE3", "ZONE4", "ZONE5", "ZONE6", "ZONE7", "ZONE8", "ZONE41"];
    
    // 초기 로드.
    $(function() {
        $("#dhlRatePop").lingoPopup({
            title : "DHL 요율 등록",
            width : 1000,
            height : 800,
            buttons : {
    ...
    function setSave() {
        ...
        var url = "/fulfillment/system/dhlRate/pop/setSave.do";
        ...
        gfn_ajax(url, true, sendData, function(data, xhr) {
            if (data.CODE == "1") {
                cfn_msg("INFO", "DHL 요율표 등록 완료");
                $("#dhlRatePop").lingoPopup("close", "OK");
            }
        });
    }
