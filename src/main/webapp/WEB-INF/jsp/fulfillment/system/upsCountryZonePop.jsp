...
<!--
    화면코드 : upsCountryZonePop
    화면명   : UPS 국가 존 등록
-->
<div id="upsCountryZonePop" class="pop_wrap">
    <!-- 그리드 시작 -->
    <div class="ct_top_wrap">
        <div class="grid_top_wrap">
            <div class="grid_top_left">UPS 국가 & 존 등록
                <span>(총 0건)</span>
            </div>
...
<script type="text/javascript">
    ...
    // 등록 컬럼.
    var _GRIDCOLUMNS = ["COUNTRY_NAME", "COUNTRY_CODE", "ZONE", "ESS"];
    
    // 초기 로드.
    $(function() {
        $("#upsCountryZonePop").lingoPopup({
            title : "국가코드, 존 등록",
            width : 1000,
            height : 800,
            buttons : {
    ...
    function setSave() {
        ...
        var url = "/fulfillment/system/upsCountryZone/setSave.do";
        ...
        gfn_ajax(url, true, sendData, function(data, xhr) {
            if (data.CODE == "1") {
                cfn_msg("INFO", "UPS 국가 존 등록 완료");
                $("#upsCountryZonePop").lingoPopup("close", "OK");
            }
        });
    }
