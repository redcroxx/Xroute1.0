...
<script type="text/javascript">
    ...
    function cfn_retrieve() {
        ...
        var url = "/fulfillment/system/upsRate/getSearch.do";
    ...
    function cfn_save() {
        ...
        if (confirm("수정하시겠습니까?")) {
            var sid = "updateUpsRate";
            var url = "/fulfillment/system/upsRate/updateUpsRate.do";
    ...
    function openLayerPopup() {
        var url = "/fulfillment/system/upsRate/pop/view.do";
        var pid = "upsRatePop";
        var params = {};
