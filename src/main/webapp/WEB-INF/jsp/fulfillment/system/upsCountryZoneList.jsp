...
<script type="text/javascript">
    ...
    function cfn_retrieve() {
        ...
        var sid = "getSearch";
        var url = "/fulfillment/system/upsCountryZone/getSearch.do";
    ...
    function cfn_save() {
        ...
        if (confirm("수정하시겠습니까?")) {
            var url = "/fulfillment/system/upsCountryZone/updateCountryZone.do";
            var sendData = {"paramList" : dataList};
            gfn_ajax(url, true, sendData, function(data, xhr) {
                if (data.CODE == "1") {
                    cfn_msg("INFO", "UPS 국가 & 존 목록 수정 완료");
                    cfn_retrieve();
                }
            });
        }
    ...
    function cfn_del() {
        ...
        if (confirm("해당 국가 [" + countryData.countryName + "] 항목을 삭제 하시겠습니까?")) {
            ...
            var url = "/fulfillment/system/upsCountryZone/setDelete.do";
    ...
    function openLayerPopup() {
        var url = "/fulfillment/system/upsCountryZone/popView.do";
        var pid = "upsCountryZonePop";
        var params = {};
