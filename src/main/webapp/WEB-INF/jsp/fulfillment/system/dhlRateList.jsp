...
<script type="text/javascript">
    ...
    function cfn_retrieve() {
        ...
        var url = "/fulfillment/system/dhlRate/getSearch.do";
    ...
    function cfn_save() {
        ...
        if (confirm("수정하시겠습니까?")) {
            var sid = "updateDhlRate";
            var url = "/fulfillment/system/dhlRate/updateDhlRate.do";
    ...
    function openLayerPopup() {
        var url = "/fulfillment/system/dhlRate/pop/view.do";
        var pid = "dhlRatePop";
        var params = {};
