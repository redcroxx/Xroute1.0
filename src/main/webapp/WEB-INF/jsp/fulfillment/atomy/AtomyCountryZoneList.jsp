...
<script type="text/javascript">
    ...
    function cfn_retrieve() {
        ...
        var sid = "getSearch";
        var url = "/fulfillment/atomy/countryZone/getSearch.do";
    ...
    function cfn_save() {
        ...
        if (confirm("수정하시겠습니까?")) {
            var url = "/fulfillment/atomy/countryZone/updateZone.do";
            var sendData = {"paramList" : dataList};
            gfn_ajax(url, true, sendData, function(data, xhr) {
                if (data.CODE == "1") {
                    cfn_msg("INFO", "국가 존 목록 수정 완료");
                    cfn_retrieve();
                }
            });
        }
    ...
    function openLayerPopup() {
        var url = "/fulfillment/atomy/countryZone/pop/view.do";
        var pid = "atomyCountryZonePop";
        var params = {};
