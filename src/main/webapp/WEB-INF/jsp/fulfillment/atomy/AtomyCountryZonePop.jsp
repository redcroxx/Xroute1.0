...
<!--
    화면코드 : AtomyCountryZonePop
    화면명   : 애터미 국가 등록
-->
<div id="atomyCountryZonePop" class="pop_wrap">
    <!-- 그리드 시작 -->
...
<script type="text/javascript">
    ...
    // 등록 컬럼.
    var _GRIDCOLUMNS = ["COUNTRY_NAME", "COUNTRY_CODE", "LOCAL_SHIPPER"];
    
    // 초기 로드.
    $(function() {
        $("#atomyCountryZonePop").lingoPopup({
            title : "국가 등록",
            width : 1000,
            height : 800,
            buttons : {
    ...
    function setSave() {
        ...
        var url = "/fulfillment/atomy/countryZone/pop/setSave.do";
        ...
        gfn_ajax(url, true, sendData, function(data, xhr) {
            if (data.CODE == "1") {
                cfn_msg("INFO", "애터미 국가 존 등록 완료");
                $("#atomyCountryZonePop").lingoPopup("close", "OK");
            }
        });
    }
