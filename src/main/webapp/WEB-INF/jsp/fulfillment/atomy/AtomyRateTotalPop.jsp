...
<!-- 검색 시작 -->
<div id="atomyRateTotalPop" class="pop_wrap">
    <!-- 그리드 시작 -->
...
<script type="text/javascript">
    ...
    function setSave() {
        ...
        var url = "/fulfillment/atomy/rateList/total/pop/setSave.do";
        ...
        gfn_ajax(url, true, sendData, function(data, xhr) {
            if (data.CODE == "1") {
                ...
                $("#atomyRateTotalPop").lingoPopup("close", "OK");
            }
        });
    }
