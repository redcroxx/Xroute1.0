...
<script type="text/javascript">
    ...
    function cfn_retrieve() {
        ...
        var url = "/fulfillment/atomy/rateList/getSearch.do";
    ...
    function cfn_save() {
        ...
        if (confirm("수정하시겠습니까?")) {
            ...
            var url = "/fulfillment/atomy/rateList/updateAtomyRate.do";
    ...
    function openLayerPopup() {
        var url = "/fulfillment/atomy/rateList/pop/view.do";
        var pid = "atomyRatePop";
        var params = {};
