...
<!--
    화면코드 : AtomyBoxSizeList
    화면명   : 애터미 국제 택배 사이즈 정보
-->
<c:import url="/comm/contentTop.do" />
<!-- 그리드 시작 -->
<div class="ct_top_wrap">
    <div class="grid_top_wrap">
        <div class="grid_top_left">애터미 국제 택배 사이즈 정보
            <span>(총 0건)</span>
        </div>
...
<script type="text/javascript">
    ...
    function cfn_retrieve() {
        ...
        var sid = "getSearch";
        var url = "/fulfillment/atomy/boxSize/getSearch.do";
    ...
    function cfn_save() {
        ...
        if (confirm("수정하시겠습니까?")) {
            var url = "/fulfillment/atomy/boxSize/updateBoxSize.do";
    ...
    function openLayerPopup() {
        var url = "/fulfillment/atomy/boxSize/pop/view.do";
        var pid = "atomyBoxSizePop";
        var params = {};
