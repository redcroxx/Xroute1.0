...
<div id="ct_sech_wrap">
    <form id="frmSearch" action="#" onsubmit="return false">
        ...
        <ul class="sech_ul">
            ...
            <li class="sech_li">
                <div style="width: 120px;">번호(SBL 제외)</div>
                <div>
...
<script type="text/javascript">
    ...
    function cfn_retrieve() {
        ...
        var url = "/fulfillment/bol/house/bl/getSearch.do";
    ...
    function setGridData() {
        ...
        $("#" + gid).gfn_setGridEvent(function(gridView, dataProvider) {
            ...
            gridView.onDataCellClicked = function(grid, data) {
                var houseBlNo = grid.getValue(data.dataRow, "houseBlNo");
                openLayerPopup("modify", houseBlNo);
            };
        });
    }
    //
    function setComplete() {
        ...
        for (var i = 0; i < gridData.length; i++) {
            var houseBlNo = $("#grid").gfn_getValue(checkRows[i], "houseBlNo");
        ...
        var url = "/fulfillment/bol/house/bl/setComplete.do";
        var sendData = {
    ...
    function openLayerPopup(obj, param) {
        ...
        if (obj == "create") {
            url = "/fulfillment/bol/house/bl/pop/create/view.do";
            pid = "createHouseBlPop";
        } else if (obj == "modify") {
            url = "/fulfillment/bol/house/bl/pop/view.do";
            pid = "houseBlPop";
            params.houseBlNo = param;
        } else {
