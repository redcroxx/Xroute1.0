...
<script type="text/javascript">
	...
	function cfn_retrieve() {
		...
		var paramData = {'URL':document.getElementById("URL").value,'KEY':document.getElementById("KEY").value,'FUNCTION':document.getElementById("FUNCTION").value,'DATA':document.getElementById("DATA").value};
		
		var sid = 'sid_getSend';
		var url = '/test/getSend.do';
