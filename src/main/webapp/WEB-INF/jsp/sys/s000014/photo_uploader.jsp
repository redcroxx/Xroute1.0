...
.pop_container .drag_area .bg{display:block;position:absolute;top:0;left:0;width:341px;height:129px;background:#fdfdfd url(/images/smarteditor/photoQuickPopup/bg_drag_image.png) 0 0 no-repeat}
...
<div id="pop_wrap">
    ...
    <div id="pop_footer">
	    <div class="btn_area">
            <a href="#"><img src="/images/smarteditor/photoQuickPopup/btn_confirm.png" width="49" height="28" alt="확인" id="btn_confirm"></a>
            <a href="#"><img src="/images/smarteditor/photoQuickPopup/btn_cancel.png" width="48" height="28" alt="취소" id="btn_cancel"></a>
        </div>
    </div>
    <!-- //footer -->
</div>
<script type="text/javascript" src="/js/smarteditor/photo_uploader/popup/jindo.min.js" charset="utf-8"></script>
<script type="text/javascript" src="/js/smarteditor/photo_uploader/popup/jindo.fileuploader.js" charset="utf-8"></script>
<script type="text/javascript" src="/js/smarteditor/photo_uploader/popup/attach_photo.js" charset="utf-8"></script>
