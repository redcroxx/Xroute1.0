...
<title>Smart Editor 2</title>
<link href="/css/smarteditor/smart_editor2.css" rel="stylesheet" type="text/css">
<style type="text/css">
	body { margin: 10px; }
</style>

<script type="text/javascript" src="/js/smarteditor/jindo.min.js" charset="utf-8"></script>
<script type="text/javascript" src="/js/smarteditor/jindo_component.js" charset="utf-8"></script>
<script type="text/javascript" src="/js/smarteditor/SE2B_Configuration_Service.js" charset="utf-8"></script>	<!-- 설정 파일 -->
<script type="text/javascript" src="/js/smarteditor/SE2B_Configuration_General.js" charset="utf-8"></script>	<!-- 설정 파일 -->
<script type="text/javascript" src="/js/smarteditor/SE2BasicCreator.js" charset="utf-8"></script>
<script src='/js/smarteditor/smarteditor2.min.js' charset='utf-8'></script>
<script src='/js/smarteditor/photo_uploader/plugin/hp_SE2M_AttachQuickPhoto.js' charset='utf-8'></script>
</head>
<body>
<span id="rev"></span>
