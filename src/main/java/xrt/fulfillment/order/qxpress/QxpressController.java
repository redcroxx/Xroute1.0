...
@Controller
@RequestMapping(value = "/fulfillment/order/qxpress")
public class QxpressController {
    
    Logger logger = LoggerFactory.getLogger(QxpressController.class);
    
    private CommonBiz commonBiz;
    private QxpressBiz qxpressBiz;

    @Autowired
    public QxpressController(CommonBiz commonBiz, QxpressBiz qxpressBiz) {
        super();
        this.commonBiz = commonBiz;
        this.qxpressBiz = qxpressBiz;
    }
    ...
    public String view(ModelMap model) throws Exception {
        ...
        return "fulfillment/order/qxpress/qxpress";
    }
    ...
    public @ResponseBody LRespData getSearch(@RequestBody CommonSearchVo paramVO) throws Exception {
        ...
        List<QxpressVO> qxpressList = qxpressBiz.getSearch(paramVO);
