 ...
 */
@Controller
@RequestMapping(value = "/fulfillment/order/ebay")
public class EbayUploadController {

	@Resource
	private CommonBiz commonBiz;
	@Resource
	private EbayUploadBiz biz;

	Logger logger = LoggerFactory.getLogger(EbayUploadController.class);
	...
	public String view(ModelMap model) throws Exception {
		...
		return "fulfillment/order/upload/EbayUpload";
	}
	...
	public LRespData upload(@RequestBody LReqData reqData) throws Exception {
		...
		List<EbayVo> orderList = (List<EbayVo>) validMap.get("orderList");
		logger.debug("2. 아마존 주문 정보 저장");
		biz.orderEbayInsert(orderList);
