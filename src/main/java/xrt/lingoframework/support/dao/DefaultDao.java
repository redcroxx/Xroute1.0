...
public class DefaultDao extends SqlSessionDaoSupport {
	...
	public <T>List<T> selectList(String mapperId, Object param) throws Exception {
	...
	public Map selectMap(String mapperId, Object params) {
		return getSqlSession().selectMap(mapperId, params, "");
	}
    ...
    public Object selectOneLE(String mapperId, Object param) throws LingoException {
        return getSqlSession().selectOne(mapperId, param);
    }

	public String selectStrOne(String mapperId, Object param) throws Exception {
		return getSqlSession().selectOne(mapperId, param);
	}
