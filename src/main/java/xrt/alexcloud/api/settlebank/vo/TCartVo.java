...
public class TCartVo implements Serializable {
    ...
    private String pmname; // 상점한글명
    private String puname; // 주문자명
    private String pename; // 영문상점명
    private String pnoti; // 기타주문정보
    private String pgoods; // 상품명
    private String pbname; // 예금주명
